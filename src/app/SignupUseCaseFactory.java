...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearUserCase(viewManagerModel, signupViewModel,clearViewModel, clearUserDataAccessObject);
    ...
    private static ClearController createClearUserCase(ViewManagerModel viewManagerModel, SignupViewModel signupViewModel, ClearViewModel clearViewModel, ClearUserDataAccessInterface userDataAccessObject) throws IOException {
